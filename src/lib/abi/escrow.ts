...
// Provided by Fortu (Telegram msg id: 362). Do not modify without verifying on-chain.
export const ESCROW_ABI = [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, name: "_transactionID", type: "uint256" },
      { indexed: true, name: "_sender", type: "address" },
      { indexed: true, name: "_receiver", type: "address" },
      { indexed: false, name: "_amount", type: "uint256" },
    ],
